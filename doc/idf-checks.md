...
|Ref|Modality|Type|Title|Details|
|---|--------|----|-----|-------|
|EF01|**error**|Both|An experiment must have at least one experimental variable specified||
|EF02|**error**|Both|An experimental variable must have name specified||
|EF03|warning|Both|An experimental variable should have a type specified||
|EF04|warning|Both|An experimental variable type should have term source specified||
...
|G09|**error**|Both|Experiment public release date must be either present or future date||
...
|PB03|warning|Both|Publication authors should be specified||
